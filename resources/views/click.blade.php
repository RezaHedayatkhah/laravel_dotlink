...
<head>
    ...
    <script>
        !function (e, t, n) {
            ...
            var a = t.getElementsByTagName("head")[0], r = new Date,
                c = "https://cdn.yektanet.com/superscript/hcWbfYTy/native-eddiecode.ir-26686/yn_pub.js?v=" + r.getFullYear().toString() + "0" + r.getMonth() + "0" + r.getDate() + "0" + r.getHours(),
    ...
    <script type='text/javascript'
            src='//pl19540384.highrevenuegate.com/f0/8c/54/f08c54d332212195dfadf9e7595b9510.js'></script>
    <script>
        (function (zp) {
            var id = Math.floor(1e7 * Math.random() + 1),
                url = location.protocol + '//www.zarpop.ir/website/pp/null/6783/' + window.location.hostname + '/?' + id;
            ...
            <div class="col p-3 text-center rounded-3 bg-body shadow" style="height: max-content;">
                ...
                <form action="{{ route('adclick', $url->url_code) }}" method="post">
                    ...
                    <button type="button" onclick="onclk(event); this.onclick=null;" id="alink"
                            class="btn btn-primary my-5 p-3">برای ادامه اینجا کلیک کنید
                    </button>
                </form>
